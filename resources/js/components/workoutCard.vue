...
<template>
  <div class="w-full flex items-center gap-4 p-4 transition-all group/ex-card" :class="[
    ...
    <div class="flex-1 min-w-0">
      ...
      <p class="text-[12px] font-bold text-secondary-text uppercase flex flex-wrap items-center gap-x-1">
