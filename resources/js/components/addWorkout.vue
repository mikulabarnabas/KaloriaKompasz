...
<template>
    <Transition enter-active-class="transition duration-200 ease-out" enter-from-class="opacity-0"
        ...
        <div v-if="show" class="fixed inset-0 z-100 overflow-y-auto flex items-center justify-center px-4 py-6">
            ...
            <div
                class="relative w-full max-w-lg bg-background-dark rounded-[2.5rem] shadow-2xl border border-neutral-border p-6 md:p-10 transform transition-all">
                ...
                <form @submit.prevent="submitForm" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <Input v-model.number="form.calories_per_unit" type="number" step="0.1"
                            :label="t('workoutDiary.calorie_label')" placeholder="0.0"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <span
                                    class="material-symbols-outlined absolute right-4 top-1/2 -translate-y-1/2 text-primary pointer-events-none text-sm group-hover:translate-y-[-40%] transition-transform">
                                    expand_more
                                </span>
                            </div>
                        </div>
