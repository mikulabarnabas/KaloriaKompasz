        ...
        <div class="max-w-4xl mx-auto space-y-10">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div
              ...
              <div class="relative z-10 flex items-baseline gap-2">
                <span
                  class="text-5xl font-black text-primary tracking-tighter group-hover:scale-105 transition-transform duration-500">{{
                    totalBurned }}</span>
            ...
            <div
              ...
              <div class="relative z-10 flex items-baseline gap-2">
                <span
                  class="text-5xl font-black text-blue-400 tracking-tighter group-hover:scale-105 transition-transform duration-500">{{
                    totalDuration }}</span>
          ...
          <div class="space-y-6">
            ...
            <div v-if="entries.length === 0"
              ...
              <div
                class="w-20 h-20 bg-neutral-dark/50 rounded-full flex items-center justify-center mx-auto mb-4 border border-neutral-border group-hover:scale-110 transition-transform">
                <span
                  class="material-symbols-outlined text-4xl text-secondary-text/30 group-hover:text-primary transition-colors">fitness_center</span>
              </div>
            ...
            <div v-else class="space-y-3">
              <div v-for="exercise in entries" :key="exercise.pivot.id"
                ...
                <div class="flex items-center gap-4 min-w-0">
                  <div
                    class="w-14 h-14 rounded-2xl bg-neutral-dark flex items-center justify-center border border-neutral-border shrink-0 group-hover:bg-primary/5 transition-colors">
                    <span
                ...
                <div class="flex items-center gap-6 shrink-0">
                  <div class="text-right">
                    <div class="text-main-text font-black text-lg tracking-tighter">{{ exercise.pivot.burned_calories
                      }}<span class="text-[10px] ml-1 opacity-40">kcal</span></div>
                  </div>
